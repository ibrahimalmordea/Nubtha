...
<div id="div4" style="display:none;margin-top: 2rem;" class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header cardheader">{{ __('تسجيل حساب جديد') }}</div>
                ...
                <div class="card-bodyadd">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <input id="type" type="hidden" class="form-control @error('type') is-invalid @enderror" name="type" value="0" required>
                        <div class="form-group row">
